<cfcomponent output="true">
	...
	<cffunction name="onApplicationStart" returnType="boolean" output="false">
		...
		<cfset Application.fyiKey 	= "imatters"> 
		<cfset Application.DSN 		= "fyi"> 
		
		<cfswitch expression="#CGI.SERVER_NAME#">
			<cfcase value="localhost">
				<cfset Application.Home = "http://127.0.0.1:850/www.foxtrotyankeeindia.com">
				<!--- <cfset Application.MetroAppID = "1482838855321210"> --->
			</cfcase>
			<cfdefaultcase>
				<cfset Application.Home = "http://www.foxtrotyankeeindia.com">
